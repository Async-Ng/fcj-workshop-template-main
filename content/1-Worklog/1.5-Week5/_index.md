...
| 6   | - Install and configure DynamoDB local with Docker <br> - Learn basics about CDK and project folder structure               | 10/10/2025 | 10/10/2025      |                    |
...
- Successfully installed and configured DynamoDB local:

  - Set up Docker environment
  - Configured DynamoDB local to run in containers
  - Tested basic operations with local DynamoDB
...
- Prepared foundation for local development workflow with AWS services.
